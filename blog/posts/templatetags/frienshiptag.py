...
from posts.models import Block, Follow, Friend
...
@register.inclusion_tag("account/followers.html")
def followers(user):
    """
...
@register.inclusion_tag("account/blockers.html")
def blockers(user):
    """
    Simple tag to grab all followers
    """
...
@register.inclusion_tag("account/blocking.html")
def blocking(user):
    """
    Simple tag to grab all users who follow the given user
    """
